...
#define DioConf_SW1_CHANNEL_ID_INDEX         (uint8)0x10
...
#define DioConf_LED1_PIN_NUM             (Dio_ChannelType)1 /* Pin 1 in PORTF */
#define DioConf_SW1_PIN_NUM              (Dio_ChannelType)4 /* Pin 4 in PORTF */
#endif /* DIO_CFG_H */
